  ...
  return (
    <button
      className={`flex-1 px-2 py-1 font-semibold rounded-md transition-all ${
        active ? "bg-white text-slate-800 shadow-md" : "bg-transparent text-slate-800"
      }`}
      onClick={onClick}
    >
