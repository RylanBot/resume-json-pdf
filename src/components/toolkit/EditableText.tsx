...
const EditableText: React.FC<EditableTextProps> = ({ text, path, type, className }) => {
  const { editorActive, inSourceMode } = useModeStore();
  const inVisualMode = editorActive && !inSourceMode;
